...
def do_build_parameters(vehicle):
    ...
    print("command param build" + cmd_param_build)
...
def get_user_locations_path():
    ...
    print("user locations path" + user_locations_path)
...
if cmd_opts.list_frame:
    ...
    frame_options_string = ' '.join(frame_options)
    #print("frame options" + frame_options_string)
    sys.exit(1)
...
if True:
    ...
    if not os.path.exists(vehicle_binary):
        ...
        sys.exit(1)
    print("vehicle binary >" + vehicle_binary)
